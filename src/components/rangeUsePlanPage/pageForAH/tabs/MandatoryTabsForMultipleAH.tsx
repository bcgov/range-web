...
function MandatoryTabsForMultipleAH(props: MandatoryTabsForMultipleAHProps) {
  const {
    user,
    clients,
    clientAgreements,
  ...
  const tabsMap: any = {
    chooseSubmissionType: {
      ...
      radio1:
        'Make this draft amendment available for the staff to review. They will advise you if the RUP is ready to submit to the decision maker for approval or make content suggestions.',
