...
function TabsForMultipleAH(props: TabsForMultipleAHProps) {
  const {
    clients,
    statusCode,
    isAgreed,
  ...
  const tabsMap: any = {
    addDescription: {
      ...
      placeholder:
        'Summarize what the proposed range use plan includes. Ex. Grazing schedules reflect change in land use and additional livestock.',
    },
    chooseSubmissionType: {
      ...
      radio1:
        'Make this draft RUP available for the staff to review. They will advise you if the RUP is ready to submit to the decision maker for approval or make content suggestions.',
    ...
    submitForFeedback: {
      ...
      next: 'last',
      text1:
        'You\u2019re ready to submit an initial range use plan for Range staff review. You will be notified once the submission has been reviewed.',
    },
