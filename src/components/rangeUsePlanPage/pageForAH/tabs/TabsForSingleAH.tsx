...
interface TabsForSingleAHProps {
  clients: any[];
...
const TabsForSingleAH: React.FC<TabsForSingleAHProps> = (props) => {
  ...
  const tabsMap: any = {
    addDescription: {
      ...
      placeholder: 'Summarize what the proposed range use plan includes. Ex. Grazing schedules reflect change in land use and additional livestock.',
    },
    chooseSubmissionType: {
      ...
      radio1: 'Make this draft RUP available for the staff to review. They will advise you if the RUP is ready to submit to the decision maker for approval or make content suggestions.',
    ...
    submitForFinalDecision: {
      ...
      checkbox1: 'I understand that this submission constitues a legal document and eSignature. This submission will be reviewed by the range staff before it is forwarded to the decision maker.',
