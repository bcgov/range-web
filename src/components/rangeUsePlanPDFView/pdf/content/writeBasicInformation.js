...
export const writeBasicInformation = (doc, plan) => {
  ...
  currY = Math.max(
    writeFieldText(
      doc,
      'Agreement Type',
      getAgreementType(agreementType),
      startX,
      currY,
      fieldTextWidth
    ),
  ...
  currY = Math.max(
    writeFieldText(
      doc,
      'Plan Start Date',
      formatDateFromServer(planStartDate),
      startX,
      currY,
      fieldTextWidth
    ),
    writeFieldText(
      doc,
      'Plan End Date',
      formatDateFromServer(planEndDate),
      halfPageWidth,
      currY,
      fieldTextWidth
    )
  ...
  currY = Math.max(
    ...
    writeFieldText(
      doc,
      'Exemption Status',
      getAgreementExemptionStatus(agreement),
      halfPageWidth,
      currY,
      fieldTextWidth
    )
