    ...
    <section className="merge-account">
      ...
      <div className="merge-account__content">
        <div className="merge-account__steps">
          <h3>
            Step 1: Search and select the account (agreement holder) which you&apos;d
            like to move to a different account:
          </h3>
          {error && (
          ...
          <div className={classes.actionSection}>
            <div className={classes.actions}>
              ...
              <Button
                ...
                disabled={sourceAccountIds.length === 0 || destinationAccount === null || sourceAccountIds.indexOf(destinationAccount.id) != -1 || isMerging}
                variant="contained"
                color="primary">
                Merge
                {isMerging && (
            ...
            {mergeError && (
              <Typography color="error">{mergeError}</Typography>
            )}
            {mergeSuccess && (
              <Typography className={classes.successMessage}>{mergeSuccess}</Typography>
            )}
          </div>
        </div>
      </div>
