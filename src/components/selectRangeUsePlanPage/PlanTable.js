...
import {
  ...
  getUser,
  getReferences,
  getIsFetchingAgreementWithAllPlan,
  getAgreementsMapWithAllPlan,
  getAgreementsMapWithAllPlanErrorOccured
...
class PlanTable extends Component {
  ...
  render() {
    ...
    const isOnlyFetchingAgreementWithAllPlan =
      isFetchingAgreementWithAllPlan && !isFetchingAgreements
...
const mapStateToProps = state => ({
  ...
  errorGettingAgreementWithAllPlan: getAgreementsMapWithAllPlanErrorOccured(
    state
  )
})
