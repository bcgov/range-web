...
class EditRupS extends Component {
  constructor(props) {
    super(props);

    const yearOptions = this.getInitialYearOptions(this.props.plan);
...
EditRupS.propTypes = propTypes;
EditRupS.defaultProps = defaultProps;
export default EditRupS;
