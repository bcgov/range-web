...
// public selectors
export const getAgreements = (state: RootState): Agreement[] =>
  fromAgreement.getAgreements(state[reducerTypes.AGREEMENTS]);
export const getAgreementIds = (state: RootState): Array<string | number> =>
...
export const getAgreementsMap = (state: RootState): EntityMap<Agreement> =>
  fromAgreement.getAgreementsMap(state[reducerTypes.AGREEMENTS]);
export const getAgreementsPagination = (state: RootState): PaginationMeta =>
  fromNetwork.getPagination(state[reducerTypes.SEARCH_AGREEMENTS]);
export const getIsFetchingAgreements = (state: RootState): boolean =>
  fromNetwork.getIsFetching(state[reducerTypes.SEARCH_AGREEMENTS]);
export const getAgreementsErrorOccured = (state: RootState): boolean =>
...
export const getIsCreatingAmendment = (state: RootState): boolean =>
...
export const getZonesMap = (state: RootState): EntityMap<Zone> =>
  fromCommonStore.getZonesMap(state[reducerTypes.COMMON]);
export const getZonesErrorOccured = (state: RootState): boolean =>
...
export const getUsersMap = (state: RootState): EntityMap<User> =>
  fromCommonStore.getUsersMap(state[reducerTypes.COMMON]);
export const getUsersErrorOccured = (state: RootState): boolean =>
...
export const getClientsMap = (state: RootState): EntityMap<Client> =>
  fromClient.getClientsMap(state[reducerTypes.CLIENT]);
export const getIsFetchingClients = (state: RootState): boolean =>
...
export const getPlansMap = (state: RootState): EntityMap<NormalizedPlan> =>
...
export const getPlanErrorOccured = (state: RootState): boolean =>
  fromNetwork.getErrorOccured(state[reducerTypes.GET_PLAN]);

export const getIsFetchingPlanPDF = (state: RootState): boolean =>
  fromNetwork.getIsFetching(state[reducerTypes.GET_PLAN_PDF]);
export const getPlanPDFErrorOccured = (state: RootState): boolean =>
...
export const getConfirmationsMap = (state: RootState): EntityMap<PlanConfirmation> =>
...
export const getPlanStatusHistoryMap = (state: RootState): EntityMap<PlanStatusHistory> =>
...
export const getIsDeletingGrazingSchedule = (state: RootState): boolean =>
  fromNetwork.getIsFetching(state[reducerTypes.DELETE_SCHEUDLE]);
