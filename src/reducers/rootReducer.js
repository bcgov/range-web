...
const appReducer = combineReducers({
  ...
  [reducerTypes.SEARCH_AGREEMENTS]: createReducer(
    networkReducer,
    reducerTypes.SEARCH_AGREEMENTS,
  ),
  [reducerTypes.GET_PLAN]: createReducer(networkReducer, reducerTypes.GET_PLAN),
  [reducerTypes.GET_PLAN_PDF]: createReducer(
    networkReducer,
    reducerTypes.GET_PLAN_PDF,
  ),
  [reducerTypes.UPDATE_USER_ID_OF_ZONE]: createReducer(
    networkReducer,
    reducerTypes.UPDATE_USER_ID_OF_ZONE,
  ),
  [reducerTypes.UPDATE_AGREEMENT_ZONE]: createReducer(
    networkReducer,
    reducerTypes.UPDATE_AGREEMENT_ZONE,
  ),
  [reducerTypes.SEARCH_CLIENTS]: createReducer(
    networkReducer,
    reducerTypes.SEARCH_CLIENTS,
  ),
  [reducerTypes.UPDATE_CLIENT_ID_OF_USER]: createReducer(
    networkReducer,
    reducerTypes.UPDATE_CLIENT_ID_OF_USER,
  ),
  [reducerTypes.UPDATE_PLAN_STATUS]: createReducer(
    networkReducer,
  ...
  [reducerTypes.DELETE_MINISTER_ISSUE_ACTION]: createReducer(
    networkReducer,
    reducerTypes.DELETE_MINISTER_ISSUE_ACTION,
  ),
  ...
  [reducerTypes.UPDATE_USER]: createReducer(
    networkReducer,
    reducerTypes.UPDATE_USER,
  ),
  [reducerTypes.GET_AGREEMENT]: createReducer(
    networkReducer,
    reducerTypes.GET_AGREEMENT,
  ),
  [reducerTypes.CREATE_AMENDMENT]: createReducer(
    networkReducer,
    reducerTypes.CREATE_AMENDMENT,
  ),
  [reducerTypes.GET_ZONES]: createReducer(
    networkReducer,
    reducerTypes.GET_ZONES,
  ),
  [reducerTypes.GET_USERS]: createReducer(
    networkReducer,
...
export const getAgreements = (state) =>
  fromAgreement.getAgreements(state[reducerTypes.AGREEMENTS]);
export const getAgreementIds = (state) =>
  fromAgreement.getAgreementIds(state[reducerTypes.AGREEMENTS]);
export const getAgreementSearchParams = (state) =>
  fromAgreement.getAgreementSearchParams(state[reducerTypes.AGREEMENTS]);
export const getAgreementsMap = (state) =>
  fromAgreement.getAgreementsMap(state[reducerTypes.AGREEMENTS]);
export const getAgreementsPagination = (state) =>
  fromNetwork.getPagination(state[reducerTypes.SEARCH_AGREEMENTS]);
export const getIsFetchingAgreements = (state) =>
  fromNetwork.getIsFetching(state[reducerTypes.SEARCH_AGREEMENTS]);
export const getAgreementsErrorOccured = (state) =>
  fromNetwork.getErrorOccured(state[reducerTypes.SEARCH_AGREEMENTS]);
...
export const getAgreementsMapWithAllPlan = (state) =>
  fromAgreementWithAllPlans.getAgreementsMap(
    state[reducerTypes.AGREEMENTS_WITH_ALL_PLANS],
  );
...
export const getIsCreatingAmendment = (state) =>
  fromNetwork.getIsFetching(state[reducerTypes.CREATE_AMENDMENT]);

export const getAuthData = (state) =>
  fromAuth.getAuthData(state[reducerTypes.AUTH]);
...
export const getReAuthRequired = (state) =>
  fromAuth.getReAuthRequired(state[reducerTypes.AUTH]);
export const getAuthTimeout = (state) =>
  fromAuth.getAuthTimeout(state[reducerTypes.AUTH]);
export const getIsFetchingUser = (state) =>
  fromNetwork.getIsFetching(state[reducerTypes.GET_USER]);
export const getFetchingUserErrorResponse = (state) =>
  fromNetwork.getErrorResponse(state[reducerTypes.GET_USER]);
export const getFetchingUserErrorOccured = (state) =>
...
export const getUpdatingUserErrorOccured = (state) =>
  fromNetwork.getErrorOccured(state[reducerTypes.UPDATE_USER]);

export const getZones = (state) =>
  fromCommonStore.getZones(state[reducerTypes.COMMON]);
export const getZonesMap = (state) =>
  fromCommonStore.getZonesMap(state[reducerTypes.COMMON]);
export const getZonesErrorOccured = (state) =>
  fromNetwork.getErrorOccured(state[reducerTypes.GET_ZONES]);
export const getReferences = (state) =>
  fromCommonStore.getReferences(state[reducerTypes.COMMON]);
export const getUsers = (state) =>
  fromCommonStore.getUsers(state[reducerTypes.COMMON]);
export const getUsersMap = (state) =>
  fromCommonStore.getUsersMap(state[reducerTypes.COMMON]);
export const getUsersErrorOccured = (state) =>
  fromNetwork.getErrorOccured(state[reducerTypes.GET_USERS]);
...
export const getClients = (state) =>
  fromClient.getClients(state[reducerTypes.CLIENT]);
export const getClientsMap = (state) =>
  fromClient.getClientsMap(state[reducerTypes.CLIENT]);
export const getIsFetchingClients = (state) =>
  fromNetwork.getIsFetching(state[reducerTypes.SEARCH_CLIENTS]);
export const getIsUpdatingClientIdOfUser = (state) =>
  fromNetwork.getIsFetching(state[reducerTypes.UPDATE_CLIENT_ID_OF_USER]);

export const getPlansMap = (state) =>
  fromPlan.getPlansMap(state[reducerTypes.PLAN]);
export const getPlanIds = (state) =>
  fromPlan.getPlanIds(state[reducerTypes.PLAN]);
export const getIsFetchingPlan = (state) =>
  fromNetwork.getIsFetching(state[reducerTypes.GET_PLAN]);
export const getPlanErrorOccured = (state) =>
  fromNetwork.getErrorOccured(state[reducerTypes.GET_PLAN]);

export const getIsFetchingPlanPDF = (state) =>
  fromNetwork.getIsFetching(state[reducerTypes.GET_PLAN_PDF]);
export const getPlanPDFErrorOccured = (state) =>
  fromNetwork.getErrorOccured(state[reducerTypes.GET_PLAN_PDF]);
export const getPlanPDF = (state) =>
  fromNetwork.getData(state[reducerTypes.GET_PLAN_PDF]);

export const getConfirmationsMap = (state) =>
  fromPlan.getConfirmationsMap(state[reducerTypes.PLAN]);
export const getPasturesMap = (state) =>
  fromPlan.getPasturesMap(state[reducerTypes.PLAN]);
export const getPlantCommunitiesMap = (state) =>
  fromPlan.getPlantCommunitiesMap(state[reducerTypes.PLAN]);
export const getGrazingSchedulesMap = (state) =>
  fromPlan.getGrazingSchedulesMap(state[reducerTypes.PLAN]);
export const getMinisterIssuesMap = (state) =>
  fromPlan.getMinisterIssuesMap(state[reducerTypes.PLAN]);
export const getPlanStatusHistoryMap = (state) =>
  fromPlan.getPlanStatusHistoryMap(state[reducerTypes.PLAN]);
...
export const getIsUpdatingPlanStatus = (state) =>
  fromNetwork.getIsFetching(state[reducerTypes.UPDATE_PLAN_STATUS]);

export const getToastsMap = (state) =>
  fromToast.getToastsMap(state[reducerTypes.TOAST]);
export const getConfirmationModalsMap = (state) =>
  fromModalReducer.getConfirmationModalsMap(state[reducerTypes.MODAL]);
export const getInputModal = (state) =>
  fromModalReducer.getInputModal(state[reducerTypes.MODAL]);
export const getIsPiaModalOpen = (state) =>
