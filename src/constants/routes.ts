...
export const ASSIGN_ROLES_AND_DISTRICTS = '/assign-roles-and-districts';
export const ADMIN_ROUTES = [MANAGE_CLIENT, MERGE_ACCOUNT, EMAIL_TEMPLATE, ASSIGN_ROLES_AND_DISTRICTS];
