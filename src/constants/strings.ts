...
export const PLAN_EXTENSION_CONFIRMATION_QUESTION = (action: string): string =>
  `Are you sure you want to ${action} extension?`;

export const PLAN_PASTE_CONFIRMATION_QUESTION = (sourceAgreement: string, destinationAgreement: string): string =>
...
export const PLAN_PASTE_AS_REPLACEMENT_PLAN_CONFIRMATION_QUESTION = (
  ...
  `Are you sure you want to paste content of ${sourceAgreement} as a replacement plan for ${destinationAgreement}? Please note - This will overwrite the existing replacement plan.`;
