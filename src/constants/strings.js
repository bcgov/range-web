...
export const SELECT_RUP_BANNER_CONTENT = 'View details of each range use plan. Enter RAN, agreement holder\'s name, or staff contact in the search box to search for a specific range use plan.';
