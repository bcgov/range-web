...
export const ELEMENT_ID = {
  ...
  PASTURES: 'pastures',
  GRAZING_SCHEDULE: 'grazing-schedule',
  MINISTER_ISSUES: 'minister-issues',
  INVASIVE_PLANT_CHECKLIST: 'invasive-plant',
  ADDITIONAL_REQUIREMENTS: 'additional-requirements',
  MANAGEMENT_CONSIDERATIONS: 'management-considerations',
  RUP_ZONE_DROPDOWN: 'rup-zone-dropdown',
  SIGN_OUT: 'sign-out',
  MANAGE_ZONE_ZONES_DROPDOWN: 'mz-zone-dropdown',
  MANAGE_ZONE_CONTACTS_DROPDOWN: 'mz-contact-dropdown',
