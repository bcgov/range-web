...
export const PDF_IN_EFFECT_STATUSES = [PLAN_STATUS.STANDS_WRONGLY_MADE, PLAN_STATUS.STANDS, PLAN_STATUS.APPROVED];

export const PDF_NOT_IN_EFFECT_STATUSES = [PLAN_STATUS.WRONGLY_MADE_WITHOUT_EFFECT, PLAN_STATUS.NOT_APPROVED];

export const APPROVED_PLAN_STATUSES = [PLAN_STATUS.APPROVED, PLAN_STATUS.STANDS, PLAN_STATUS.STANDS_WRONGLY_MADE];

export const NOT_DOWNLOADABLE_PLAN_STATUSES = [PLAN_STATUS.DRAFT, PLAN_STATUS.STAFF_DRAFT];
