...
const DEV_API_BASE_URL = process.env.REACT_APP_API_URL || 'https://myrangebc-dev.apps.silver.devops.gov.bc.ca/api';
const DEV = {
...
export const UPDATE_PLAN_STATUS = (planId: string | number): string => `/v1/plan/${planId}/status`;
export const UPDATE_RUP = (planId: string | number): string => `/v1/plan/${planId}`;
export const EXTEND_PLAN = (planId: string | number, endDate: string): string =>
...
export const UPDATE_CONFIRMATION = (planId: string | number, confirmationId: string | number): string =>
...
export const GET_RUP_VERSION = (planId: string | number, version: string | number): string =>
  `/v1/plan/${planId}/version/${version}`;
export const DOWNLOAD_RUP_VERSION = (planId: string | number, version: string | number): string =>
  `/v1/plan/${planId}/version/${version}/download`;
export const DOWNLOAD_AGREEMENT_EXEMPTION = (agreementId: string | number, exemptionId: string | number): string =>
  `/v1/agreement/${agreementId}/exemption/${exemptionId}/download`;
export const TRANSITION_EXEMPTION = (agreementId: string | number, exemptionId: string | number): string =>
  `/v1/agreement/${agreementId}/exemption/${exemptionId}/transition`;
export const RESTORE_RUP_VERSION = (planId: string | number, version: string | number): string =>
  `v1/plan/${planId}/version/${version}/restore`;

export const GET_RUP_PDF = (planId: string | number): string => `/v1/plan/${planId}/PDF`;
export const CREATE_RUP_ATTACHMENT = (planId: string | number): string => `/v1/plan/${planId}/attachment`;
export const DELETE_RUP_ATTACHMENT = (planId: string | number, attachmentId: string | number): string =>
  `/v1/plan/${planId}/attachment/${attachmentId}`;
export const UPDATE_RUP_ATTACHMENT = (planId: string | number, attachmentId: string | number): string =>
  `/v1/plan/${planId}/attachment/${attachmentId}`;

export const GET_SIGNED_URL = (fileName: string): string => `/v1/files/upload-url?name=${fileName}`;
...
export const DELETE_RUP_PASTURE = (planId: string | number, pastureId: string | number): string =>
  `/v1/plan/${planId}/pasture/${pastureId}`;

export const CREATE_RUP_SCHEDULE = (planId: string | number): string => `/v1/plan/${planId}/schedule`;
export const UPDATE_RUP_SCHEDULE = (planId: string | number, scheduleId: string | number): string =>
  `/v1/plan/${planId}/schedule/${scheduleId}`;
export const DELETE_RUP_SCHEDULE = (planId: string | number, scheduleId: string | number): string =>
  `/v1/plan/${planId}/schedule/${scheduleId}`;
export const GET_PASTURES_FOR_DISTRICT = (districtId: string | number): string =>
  `/v1/pasture?districtId=${districtId}`;
export const DELETE_RUP_SCHEDULE_ENTRY = (
  planId: string | number,
  scheduleId: string | number,
  entryId: string | number,
): string => `/v1/plan/${planId}/schedule/${scheduleId}/entry/${entryId}`;

export const CREATE_RUP_MINISTER_ISSUE = (planId: string | number): string => `/v1/plan/${planId}/issue`;
export const UPDATE_RUP_MINISTER_ISSUE = (planId: string | number, issueId: string | number): string =>
  `/v1/plan/${planId}/issue/${issueId}`;
export const DELETE_RUP_MINISTER_ISSUE = (planId: string | number, issueId: string | number): string =>
  `/v1/plan/${planId}/issue/${issueId}`;
export const CREATE_RUP_MINISTER_ISSUE_ACTION = (planId: string | number, issueId: string | number): string =>
  `/v1/plan/${planId}/issue/${issueId}/action`;
export const UPDATE_RUP_MINISTER_ISSUE_ACTION = (
  planId: string | number,
  issueId: string | number,
  actionId: string | number,
): string => `/v1/plan/${planId}/issue/${issueId}/action/${actionId}`;
export const DELETE_RUP_MINISTER_ISSUE_ACTION = (
  planId: string | number,
  issueId: string | number,
  actionId: string | number,
): string => `/v1/plan/${planId}/issue/${issueId}/action/${actionId}`;

export const CREATE_RUP_PLANT_COMMUNITY = (planId: string | number, pastureId: string | number): string =>
  `/v1/plan/${planId}/pasture/${pastureId}/plant-community`;
export const UPDATE_RUP_PLANT_COMMUNITY = (
  planId: string | number,
  pastureId: string | number,
  plantId: string | number,
): string => `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${plantId}`;
export const DELETE_RUP_PLANT_COMMUNITY = (
  planId: string | number,
  pastureId: string | number,
  plantId: string | number,
): string => `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${plantId}`;
...
): string => `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${communityId}/action`;
export const UPDATE_RUP_PLANT_COMMUNITY_ACTION = (
  planId: string | number,
  pastureId: string | number,
  communityId: string | number,
  actionId: string | number,
): string => `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${communityId}/action/${actionId}`;
...
export const CREATE_RUP_INDICATOR_PLANT = (
  planId: string | number,
  pastureId: string | number,
  communityId: string | number,
): string => `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${communityId}/indicator-plant`;
export const UPDATE_RUP_INDICATOR_PLANT = (
  planId: string | number,
  pastureId: string | number,
  communityId: string | number,
  plantId: string | number,
): string => `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${communityId}/indicator-plant/${plantId}`;
...
export const CREATE_RUP_MONITERING_AREA = (
  planId: string | number,
  pastureId: string | number,
  communityId: string | number,
): string => `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${communityId}/monitoring-area`;
export const UPDATE_RUP_MONITORING_AREA = (
  planId: string | number,
  pastureId: string | number,
  communityId: string | number,
  areaId: string | number,
): string => `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${communityId}/monitoring-area/${areaId}`;
...
export const CREATE_RUP_INVASIVE_PLANT_CHECKLIST = (planId: string | number): string =>
  `/v1/plan/${planId}/invasive-plant-checklist`;
export const UPDATE_RUP_INVASIVE_PLANT_CHECKLIST = (planId: string | number, checklistId: string | number): string =>
  `/v1/plan/${planId}/invasive-plant-checklist/${checklistId}`;
export const CREATE_RUP_MANAGEMENT_CONSIDERATION = (planId: string | number): string =>
  `/v1/plan/${planId}/management-consideration`;
export const UPDATE_RUP_MANAGEMENT_CONSIDERATION = (
  planId: string | number,
  considerationId: string | number,
): string => `/v1/plan/${planId}/management-consideration/${considerationId}`;
export const DELETE_RUP_MANAGEMENT_CONSIDERATION = (
  planId: string | number,
  considerationId: string | number,
): string => `/v1/plan/${planId}/management-consideration/${considerationId}`;
export const CREATE_RUP_ADDITIONAL_REQUIREMENT = (planId: string | number): string =>
  `/v1/plan/${planId}/additional-requirement`;
export const UPDATE_RUP_ADDITIONAL_REQUIREMENT = (planId: string | number, requirementId: string | number): string =>
  `/v1/plan/${planId}/additional-requirement/${requirementId}`;
export const DELETE_RUP_ADDITIONAL_REQUIREMENT = (planId: string | number, requirementId: string | number): string =>
  `/v1/plan/${planId}/additional-requirement/${requirementId}`;
