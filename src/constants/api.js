...
export const DELETE_USER_CLIENT_LINK = (userId, clientId) => `/v1/user/${userId}/client/${clientId}`;
...
export const EXTEND_PLAN = (planId, endDate) => `/v1/plan/${planId}/extension/extend?endDate=${endDate}`;
export const REQUEST_EXTENSION = (planId) => `/v1/plan/${planId}/extension/request`;
...
export const REPLACEMENT_PLAN = (planId) => `/v1/plan/${planId}/extension/createReplacementPlan`;
...
export const GET_RUP_FUTURE_PLAN = (planId, version) => `/v1/plan/${planId}/version/${version}`;
...
export const DELETE_RUP_ATTACHMENT = (planId, attachmentId) => `/v1/plan/${planId}/attachment/${attachmentId}`;
...
export const DELETE_RUP_PLANT_COMMUNITY = (planId, pastureId, plantId) =>
  `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${plantId}`;
export const CREATE_RUP_PLANT_COMMUNITY_ACTION = (planId, pastureId, communityId) =>
  `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${communityId}/action`;
export const UPDATE_RUP_PLANT_COMMUNITY_ACTION = (planId, pastureId, communityId, actionId) =>
  `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${communityId}/action/${actionId}`;
export const DELETE_RUP_PLANT_COMMUNITY_ACTION = (planId, pastureId, communityId, actionId) =>
  `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${communityId}/action/${actionId}`;
...
export const UPDATE_RUP_INDICATOR_PLANT = (planId, pastureId, communityId, plantId) =>
  `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${communityId}/indicator-plant/${plantId}`;
export const DELETE_RUP_INDICATOR_PLANT = (planId, pastureId, communityId, plantId) =>
  `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${communityId}/indicator-plant/${plantId}`;
...
export const UPDATE_RUP_MONITORING_AREA = (planId, pastureId, communityId, areaId) =>
  `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${communityId}/monitoring-area/${areaId}`;
export const DELETE_RUP_MONITORING_AREA = (planId, pastureId, communityId, areaId) =>
  `/v1/plan/${planId}/pasture/${pastureId}/plant-community/${communityId}/monitoring-area/${areaId}`;
...
export const UPDATE_SCHEDULE_SORT_ORDER = (planId, scheduleId) => `/v1/plan/${planId}/schedule/${scheduleId}/sortOrder`;
