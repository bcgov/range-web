...
export const createRUPMinisterIssueAction = (planId, issueId, action) => (
  dispatch,
  getState
) => {
  return axios
...
export const createRUPMinisterIssueAndActions = (planId, issue) => (
  dispatch,
  getState
) => {
  ...
  const makeRequest = async () => {
    try {
      ...
      const newActions = await Promise.all(
        issue.ministerIssueActions.map(mia =>
      ...
      dispatch(
        success(
          reducerTypes.CREATE_MINISTER_ISSUE_AND_ACTIONS,
          newIssueWithNewActions
        )
      )
...
export const updateRUPMinisterIssueAction = (planId, issueId, action) => (
  dispatch,
  getState
) => {
  return axios
...
export const updateRUPMinisterIssueAndActions = (planId, issue) => (
  dispatch,
  getState
) => {
  ...
  const makeRequest = async () => {
    try {
      ...
      dispatch(
        success(
          reducerTypes.UPDATE_MINISTER_ISSUE_AND_ACTIONS,
...
export const deleteRUPMinisterIssue = (planId, issueId) => (
  dispatch,
  getState
) => {
  return axios
...
export const deleteRUPMinisterIssueAction = (planId, issueId, actionId) => (
  dispatch,
  getState
) => {
  ...
  return axios
    ...
    .then(
      response => {
        dispatch(
          success(reducerTypes.DELETE_MINISTER_ISSUE_ACTION, response.data)
        )
        return response.data
      },
      err => {
