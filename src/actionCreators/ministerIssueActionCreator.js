...
export const createRUPMinisterIssueAction =
  (planId, issueId, action) => (dispatch, getState) => {
    return axios
      .post(
...
export const createRUPMinisterIssueAndActions =
  (planId, issue) => (dispatch, getState) => {
...
export const createOrUpdateRUPMinisterIssueActions =
  (planId, issueId, actions) => (dispatch) => {
    const makeRequest = async () => {
      return await Promise.all(
        actions.map((action) => {
          ...
          return dispatch(
            updateRUPMinisterIssueAction(planId, issueId, action),
          );
        }),
      );
    };
...
export const deleteRUPMinisterIssue =
  (planId, issueId) => (dispatch, getState) => {
    return axios
      .delete(
...
export const deleteRUPMinisterIssueAction =
  (planId, issueId, actionId) => (dispatch, getState) => {
