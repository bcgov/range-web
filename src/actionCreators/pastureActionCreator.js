...
export const createRUPPlantCommunityAction = (planId, pastureId, communityId, action) => (dispatch, getState) => {
  const { ...data } = action;
...
export const createRUPIndicatorPlant = (planId, pastureId, communityId, plant) => (dispatch, getState) => {
  const { ...data } = plant;
...
export const createRUPMonitoringArea = (planId, pastureId, communityId, area) => (dispatch, getState) => {
  const { ...data } = area;
