...
export const updateRUPManagementConsideration =
  (planId, consideration) => (dispatch, getState) => {
    return axios
      .put(
...
export const deleteRUPManagementConsideration =
  (planId, considerationId) => (dispatch, getState) => {
