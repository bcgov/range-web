...
//@Title('Feature: backupTC Results')
...
//        given: "that I am doing a map based search on the backupTC tool"
//            to SearchPage
//            assert waitFor { ( map_zoomlevel.text() == "500 km" ) }
...
//        then: "I should see a box appear on the map that states 'backupTC Wells In This Area'"
...
//        and: "a yellow warning label appear under the Groundwater Well backupTC that states 'No well records could be found'"
//            assert waitFor { not_found_msg.displayed == true }
//    }
//
//    @Unroll
